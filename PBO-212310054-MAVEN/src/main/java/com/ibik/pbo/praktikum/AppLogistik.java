	        ...
	        mainloop: do {
	            try {
	                ...
	                if (value == null) {
	                    ...
	                    if (exit == 0) {
	                        JOptionPane.showMessageDialog(null, "Terima Kasih!", "heraz Expedition",
	                ...
	                switch (menu) {
	                    case 1:
	                        ...
	                        for (int h = 0; h < field.length; h++) {
	                            String values = JOptionPane.showInputDialog(null, "Masukkan " + field[h],
	                                    "Cek Ongkir",
	                                    JOptionPane.QUESTION_MESSAGE);
	                            if (values == null) {
